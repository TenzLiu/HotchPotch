package com.tenz.hotchpotch.widget.edittext;
...
/**
 * Author: TenzLiu
 * Date: 2018-01-20 18:54
 * Description: ClearWriteEditText
 */
...
public class ClearWriteEditText extends EditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        this.setBackground(getResources().getDrawable(R.drawable.selector_et_clear));
